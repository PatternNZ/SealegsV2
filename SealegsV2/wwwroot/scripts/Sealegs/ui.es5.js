...
UI.prototype = {
    ...
    setupFullWidthVideos: function setupFullWidthVideos() {
    ...
    moveWhiteCovers: function moveWhiteCovers() {
    ...
    configureTakeOverBanner: function configureTakeOverBanner() {
        try {
    ...
    setupALinks: function setupALinks() {
        var self = this;
        $("a").each(function () {
    ...
    appendHtmlWithScripts: function appendHtmlWithScripts(container, html) {
